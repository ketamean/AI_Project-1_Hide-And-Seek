...
if __name__ == "__main__":
    ...
    if val == 1:
        ...
        lv1 = static_hiders.Level1(input_filepath=FILENAME)
        ...
        prob = problem.Problem(input_filename='map1_4.txt', allow_move_obstacles=False)
        lv3 = dynamic_hiders.Level3(file_path='map1_4.txt')
        game = lv3.run()
    elif val == 4:
        pass
